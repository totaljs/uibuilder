...
Version: 1
Updated: 2024-06-17T08:09:00.000Z
Author: Peter Širka
...
Component: j-Crop
Version: 1
Updated: 2023-12-28T23:11:01.000Z
Author: Peter Širka
...
Version: 1
Updated: 2024-04-23T13:49:01.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-07-25T09:29:01.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-08-02T15:48:04.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-01-31T11:49:01.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-01-31T12:15:01.000Z
Author: Peter Širka
...
Version: 1
Updated: 2024-04-01T20:23:02.000Z
Author: Peter Širka
...
Version: 1
Updated: 2024-06-24T10:34:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2024-05-21T15:25:00.000Z
Author: Peter Širka
...
Version: 1
Updated: 2023-06-19T14:50:00.000Z
Author: Peter Širka
...
Component: j-Windows
Version: 1
Updated: 2023-01-17T22:59:02.000Z
Author: Peter Širka
*/
...
COMPONENT('searchinput','searchicon:ti ti-search;cancelicon:ti ti-times;align:left',function(self,config,cls){var input,icon,prev,prev2;self.autobind20&&self.autobind20();self.novalidate&&self.novalidate();self.make=function(){self.aclass(cls+' '+cls+'-'+config.align);self.html('<span><i class="{0}"></i></span><div><input type="text" autocomplete="new-password" maxlength="100" placeholder="{1}" data-jc-bind /></div>'.format(config.searchicon,config.placeholder));input=self.find('input')[0];icon=self.find('i');self.event('click','span',function(){prev&&self.set('');prev2=''});config.autofocus&&self.autofocus()};self.focus=function(){input&&input.focus()};self.check=function(){var is=!!input.value.trim();if(is!==prev){icon.rclass().aclass(is?config.cancelicon:config.searchicon);prev=is;self.tclass(cls+'-is',is)}};self.clear=function(){input.value='';config.exec&&self.SEEX(config.exec,input.value,self.element);self.check()};self.setter=function(value,path,type){var val=value||'';if(input.value!==val)input.value=val;if(prev2!==input.value){prev2=input.value;type&&config.exec&&self.SEEX(config.exec,input.value,self.element)}self.check()}});
